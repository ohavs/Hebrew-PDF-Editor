...
const TOOLS: Array<{ id: ToolType; label: string; icon: React.ReactNode; group?: string }> = [
  ...
  { id: 'underline', label: 'tools.underline', icon: <UnderlineIcon />, group: 'annotate' },
  { id: 'strikethrough', label: 'tools.strikethrough', icon: <StrikeIcon />, group: 'annotate' },
  ...
  { id: 'eraser', label: 'tools.eraser', icon: <EraserIcon />, group: 'draw' },
...
}> = ({ title, active, disabled, onClick, children, size = 36 }) => (
  <button
...
function UnderlineIcon() {
  return <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M6 3v7a6 6 0 0012 0V3M4 21h16"/></svg>
}
function StrikeIcon() {
  return <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M17 6H7m10 6H7m5-6v12"/><line x1="4" y1="12" x2="20" y2="12" strokeWidth="2"/></svg>
}
function DrawIcon() {
...
function EraserIcon() {
  return <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M19 20H7l-4-4 9-9 7 7-4 4M7 8l4 4"/></svg>
}
function FormsIcon() {
