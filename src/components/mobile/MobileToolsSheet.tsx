...
const ANNOTATION_TOOLS: Array<{ id: ToolType; label: string; icon: React.ReactNode; color: string }> = [
  { id: 'edit-text',    label: 'ערוך טקסט', color: '#0ea5e9', icon: <svg width="22" height="22" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M4 7V5h12v2M10 5v12M8 17h4"/><path strokeLinecap="round" strokeLinejoin="round" d="M14.5 20.5l6-6 2 2-6 6h-2v-2z"/></svg> },
...
const PDF_TOOLS: Array<{ id: CategoryId; label: string; desc: string; color: string; icon: React.ReactNode }> = [
  ...
  { id: 'from-word',  label: 'וורד ל-PDF', desc: 'המר מסמך DOCX ל-PDF',         color: '#1d4ed8', icon: <svg width="22" height="22" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M14 3v5h5M14 3H7a2 2 0 00-2 2v14a2 2 0 002 2h10a2 2 0 002-2V8l-5-5z"/><path strokeLinecap="round" strokeLinejoin="round" d="M12 11v6m0 0l-2.5-2.5M12 17l2.5-2.5"/></svg> },
  { id: 'flipbook',   label: 'פליפבוק ל-PDF', desc: 'הרכב PDF מעמודי פליפבוק',  color: '#a855f7', icon: <svg width="22" height="22" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v14M12 6C10.5 4.8 8.6 4 6 4H3v14h3c2.6 0 4.5.8 6 2M12 6c1.5-1.2 3.4-2 6-2h3v14h-3c-2.6 0-4.5.8-6 2"/></svg> },
  { id: 'unlock',     label: 'הסרת הגנה', desc: 'הסר סיסמה והגבלות',           color: '#059669', icon: <svg width="22" height="22" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24"><rect x="4" y="10" width="16" height="11" rx="2"/><path strokeLinecap="round" d="M8 10V7a4 4 0 017.5-2"/><path strokeLinecap="round" d="M12 14v3"/></svg> },
  { id: 'to-excel',   label: 'PDF לאקסל', desc: 'ייצא טבלאות כ-XLSX',          color: '#16a34a', icon: <svg width="22" height="22" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="16" rx="2"/><path strokeLinecap="round" d="M3 10h18M9 4v16"/><path strokeLinecap="round" d="M13 13l4 4m0-4l-4 4"/></svg> },
  { id: 'page-numbers', label: 'מספור', desc: 'הוסף מספרי עמודים',              color: '#0891b2', icon: <svg width="22" height="22" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24"><rect x="4" y="3" width="16" height="18" rx="2"/><path strokeLinecap="round" d="M12 17h.01M9 7h6M9 11h6"/></svg> },
]
