...
export const MobileHeader: React.FC = () => {
  ...
  // Straight home when the editor was opened directly (a shared link, a PWA
  // launch) — history.back() there would leave the app
  const goBack = () => {
  ...
  return (
    <>
      ...
      >
        {/* Back one step */}
        <HeaderBtn ariaLabel="חזור" onClick={goBack}>
